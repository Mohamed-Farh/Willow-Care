                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <div class="example-tools justify-content-center">
                                <a href="{{route('categories.index')}}" class="btn btn-warning mr-2">Back</a>
                            </div>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form class="form" action="{{route('categories.update',$category->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_ro" value="{{old('name_ro',$category->name_ro)}}"/>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="checkbox-list">
                                    <label class="checkbox checkbox-outline">
                                        <input @if($category->active==1) checked @endif name="active" type="checkbox"/>
                                        <span></span></label>
                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        avatar4.on('remove', function(imageInput) {
            ...
            if(confirmed){
                $.ajax({
                    url: "{{ route('delCatImg', ['id'=>$category->id]) }}",
                    type: "POST",
