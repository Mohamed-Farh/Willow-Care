...
<head><base href="../../../../">
    ...
    <link href="{{asset('dashboard/assets/css/pages/login/classic/login-5.css')}}" rel="stylesheet" type="text/css" />
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-5 login-signin-on d-flex flex-row-fluid" id="kt_login">
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
             style="background-image: url({{asset('dashboard/assets/media/bg/bg-2.jpg')}});">
                ...
                <div class="login-signin">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="form" id="kt_login_signin_form">
                        ...
                        <div class="form-group">
                            <input class="form-control h-auto text-white bg-white-o-5
