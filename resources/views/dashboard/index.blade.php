        ...
        <div class="col-lg-5 col-xxl-4">
            ...
            <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                ...
                <div class="card-header border-0 bg-info py-5">
                    <h3 class="card-title font-weight-bolder text-white"> Application Statics</h3>
                ...
                <div class="card-body p-0 position-relative overflow-hidden">
                    <!--begin::Chart-->
                    <div  class="card-rounded-bottom bg-info" style="height: 200px"></div>
                    <!--end::Chart-->
                    <!--begin::Stats-->
        ...
        <div class="col-lg-4 col-xxl-4">
            ...
            <div class="card card-custom card-stretch card-stretch-half gutter-b">
                ...
                <div class="card-body p-0">
                    ...
                    <div id="" class="card-rounded-bottom"
