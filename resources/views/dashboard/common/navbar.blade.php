                                        ...
                                        <ul class="menu-subnav">
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="javascript:;" class="menu-link">
                                                    ...
                                                    <span class="menu-label">
																			<span
                                                                                class="label label-danger label-rounded">3</span>
																		</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm"
                             src="{{asset('dashboard/assets/media/svg/flags/'.\LaravelLocalization::getCurrentLocaleName().'.svg')}}" alt=""/>
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
                        ...
                        <li class="navi-item">
                            <a  rel="alternate" hreflang="{{ $localeCode }}"
                                ...
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{asset('dashboard/assets/media/svg/flags/'.$properties['name'].'.svg')}}" alt=""/>
                                </span>
