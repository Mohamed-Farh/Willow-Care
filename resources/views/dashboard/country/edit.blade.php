                    ...
                    <form class="form" action="{{route('countries.update',$country->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_ar" value="{{old('name_ar',$country->name_ar)}}"/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_ro" value="{{old('name_ro',$country->name_ro)}}"/>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="checkbox-list">
                                    <label class="checkbox checkbox-outline">
                                        <input @if($country->active==1) checked @endif name="active" type="checkbox"/>
                                        <span></span></label>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-9 col-xl-6">
                                        <div  class="image-input image-input-outline" id="kt_image_4"
                                              style="background-image: url({{asset($country->flag)}})">
...
@section('scripts')
    ...
    <script>
        ...
        avatar4.on('remove', function(imageInput) {
            ...
            if(confirmed){
                $.ajax({
                    url: "{{ route('delCountryImg', ['id'=>$country->id]) }}",
                    type: "POST",
